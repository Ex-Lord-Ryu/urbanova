...
<section class="section">
    <div class="page-header-bg">
        <h1 class="products-title mb-3">Tambah Warna Baru</h1>
            ...
            <div class="col-12">
                <div class="card products-card">
                    <div class="card-header products-header d-flex align-items-center">
                        ...
                        <h4 class="products-title mb-0">Form Tambah Warna</h4>
                    </div>
                    <div class="card-body">
                        @if(session('error'))
                        ...
                        <form action="{{ route('colors.store') }}" method="POST">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control @error('hex_code') is-invalid @enderror" id="hex_code" name="hex_code" value="{{ old('hex_code') }}" placeholder="FF5733" maxlength="6">
                                            <div class="input-group-append">
                                                <span class="input-group-text p-0">
                                                    <input type="color" id="color_picker" class="border-0" style="width: 40px; height: 38px;">
                                                </span>
                                            </div>
                                            @error('hex_code')
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center">
                                                <div id="color_preview" style="width: 50px; height: 50px; border-radius: 5px; border: 1px solid #ddd; margin-right: 15px;"></div>
                                                <div>
                                                    <h5 id="color_name_preview">Nama Warna</h5>
                                                    <code id="color_code_preview">#FFFFFF</code>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="form-actions mt-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save mr-1"></i> Simpan Warna
                                </button>
