                ...
                <div class="card products-card">
                    ...
                    <div class="card-body">
                        <div class="alert alert-info" role="alert">
                            <i class="fas fa-info-circle mr-1"></i> Perubahan terbaru: Sistem harga telah diperbarui untuk mendukung varian produk. Pastikan harga dasar (base price) diisi dengan benar.
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <small class="form-text text-muted">SKU sudah di-generate otomatis saat pembuatan produk</small>
                                        @error('sku')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="current-image mb-3">
                                        <div class="file-preview-item">
                                            ...
                                            <div class="file-preview-overlay">Gambar Saat Ini</div>
                                        </div>
                                        </div>
                                        @endif
                                        <div class="file-input-container">
                                    <div class="file-input-field" id="image-filename">Pilih Gambar Baru</div>
                                ...
                                <small class="form-text text-muted">Format: JPG, PNG, JPEG, GIF. Maks: 2MB. Kosongkan jika tidak ingin mengubah gambar.</small>
                                    </div>
                                                ...
                                                <div class="file-preview-item">
                                                    ...
                                                    <div class="file-preview-overlay">
                                                        <div class="file-actions">
                                                            <input type="checkbox" name="delete_images[]" value="{{ $image->id }}" id="delete_img_{{ $image->id }}" class="delete-image-checkbox">
                                                            <label for="delete_img_{{ $image->id }}" class="delete-image-label">Hapus</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    $(document).ready(function() {
        ...
        $(".file-input").on("change", function() {
            ...
            if ($(this).attr('multiple') && this.files.length > 1) {
                ...
                fileName = $(this).attr('id') === 'image' ? 'Pilih Gambar Baru' : 'Pilih Beberapa Gambar';
            }
        ...
        $(document).on('click', '.file-preview-remove', function() {
            ...
            var defaultText = fileInput.attr('id') === 'image' ? 'Pilih Gambar Baru' : 'Pilih Beberapa Gambar';
